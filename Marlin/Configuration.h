...
#define STRING_CONFIG_H_AUTHOR "hjc3d" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 50, 2000 }//{ 3000, 3000, 100, 3000 }
 ...
 */
#define DEFAULT_ACCELERATION          1000 //500  // X, Y, Z and E acceleration for printing moves
...
//
// HJC LCD Smart Controller shipped by
// default with the HCmaker7(for HJC2560C_REV2.x).
//
