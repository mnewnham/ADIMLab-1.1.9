...
//****************************************************************************************
#if HAS_LCD_CONTRAST_PWM
  uint8_t lcd_contrast_pwm;  // LCD Contrast wants INT

  void set_lcd_contrast_pwm() {
  	  SET_OUTPUT(LCD_CONTRAST_PIN);
      if (USEABLE_HARDWARE_PWM(LCD_CONTRAST_PIN))
        analogWrite(LCD_CONTRAST_PIN, lcd_contrast_pwm);
}
#endif
//*****************************************************************************************
...
//******************************************************************
  #if HAS_LCD_CONTRAST_PWM
    lcd_contrast_pwm = LCD_CONTRAST_DEFAULT;
    set_lcd_contrast_pwm();
  #endif  //HAS_LCD_CONTRAST_PWM
