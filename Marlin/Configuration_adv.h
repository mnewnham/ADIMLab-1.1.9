 ...
 * LCD contrast
 */
//#define LCD_CONTRAST_PWM_ENABLE
//#if ENABLED(LCD_CONTRAST_PWM_ENABLE)
 ...
 *    PWM_MOTOR_CURRENT - used by MINIRAMBO & ULTIMAIN_2 & HJC2560C_REV2.x(A4988)
...
#define MOTOR_CURRENT_PWM_RANGE 2000    //Rs=0.05R
//#define MOTOR_CURRENT_PWM_RANGE 1391      //Rs=0.1R
#define PWM_MOTOR_CURRENT { 1350,1350,1250 }          // Values in milliamps
...
// Include a page of Board Rev. and Firmware Rev. in the LCD Main Menu
#define LCD_REV_MENU
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH    0//25  // (mm) Slow length, to allow time to insert material.
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   6  // (mm/s) Load filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    0//50  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
